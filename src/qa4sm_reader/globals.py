...
_dataset_pretty_names = {  # from qa4sm\validator\fixtures\datasets.json
    ...
    'ESA_CCI_SM_combined_medium_resolution' : 'ESA CCI SM combined medium resolution',
...
def get_resolution_info(dataset, raise_error=False):
    ...
    resolution = {  # from /qa4sm/validator/fixtures/datasets.json
        ...
        'ESA_CCI_SM_combined_medium_resolution' : 0.1,
    ...
    resolution_units = {  # from /qa4sm/validator/fixtures/datasets.json
        ...
        'ESA_CCI_SM_combined_medium_resolution' : 'deg',
...
DATASETS = [
    ...
    'ASCAT',
    'ESA_CCI_SM_combined',
    'ESA_CCI_SM_combined_medium_resolution',
    'ESA_CCI_SM_active',
    'ESA_CCI_SM_passive',
    'ESA_CCI_RZSM',
    'SMOS_IC',
